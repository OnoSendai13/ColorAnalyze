...
export const DARK = {
  ...
  // Contour NEUTRE systématique pour tout échantillon de couleur en aplat :
  // visible aussi bien sur une pastille très claire que très sombre.
  swatchBorder: 'rgba(128,128,128,0.5)',
  statusBar: 'light',
  isDark: true,
};
  ...
  return (
    ...
    >
      <Feather
        ...
        size={19}
        color={isDark ? theme.accentSecondary : theme.accent}
      />
    </Pressable>
  );
}
